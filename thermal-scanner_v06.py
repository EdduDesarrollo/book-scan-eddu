...
class CamApp(App):
    ...
    def __init__(self, **kwargs):
        ...
        self.camara_previ = '0'
        self.lview = False
        self.img1 = Image(source='logo.png', size=(1024,768))
        self.title = TITULO
        ...
        self.umbral_px_blancos_16mm = 2200
        ...
        try:
            ...
            while intentos < max_intentos:
                ...
                if self.alinear_perforacion(image_array):
                    ...
                    self.logger.error(f"Primer foto {self.primer_foto}")
                    self.logger.error(f"contador_perforaciones {contador_perforaciones}")
                    self.logger.error(f"cantidad_perforaciones {self.cantidad_perforaciones}")
